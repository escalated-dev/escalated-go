...
func (m *widgetMockStore) ListTicketSubjectLinks(_ context.Context, _ int64) ([]*models.TicketSubjectLink, error) {
	return nil, nil
}
func (m *widgetMockStore) GetTicketSubjectLink(_ context.Context, _ int64) (*models.TicketSubjectLink, error) {
	return nil, nil
}
func (m *widgetMockStore) UpsertTicketSubjectLink(_ context.Context, _ *models.TicketSubjectLink) error {
	return nil
}
func (m *widgetMockStore) DeleteTicketSubjectLink(_ context.Context, _ int64) error { return nil }
func (m *widgetMockStore) DeleteTicketSubjectLinksByTicket(_ context.Context, _ int64) error {
	return nil
}
func (m *widgetMockStore) MaxTicketSubjectPosition(_ context.Context, _ int64) (int, error) {
	return -1, nil
}
...
func (m *widgetMockStore) ListSavedViews(_ context.Context, _ models.UserID, _ bool) ([]*models.SavedView, error) {
	return nil, nil
}
...
func (m *widgetMockStore) ReorderSavedViews(_ context.Context, _ models.UserID, _ []int64) error {
	return nil
}
...
func (m *widgetMockStore) CreateChatSession(_ context.Context, _ *models.ChatSession) error {
	return nil
}
func (m *widgetMockStore) GetChatSession(_ context.Context, _ int64) (*models.ChatSession, error) {
	return nil, nil
}
func (m *widgetMockStore) GetChatSessionByTicket(_ context.Context, _ int64) (*models.ChatSession, error) {
	return nil, nil
}
func (m *widgetMockStore) UpdateChatSession(_ context.Context, _ *models.ChatSession) error {
	return nil
}
func (m *widgetMockStore) ListChatSessions(_ context.Context, _ models.ChatSessionFilters) ([]*models.ChatSession, error) {
	return nil, nil
}
func (m *widgetMockStore) CreateChatRoutingRule(_ context.Context, _ *models.ChatRoutingRule) error {
	return nil
}
func (m *widgetMockStore) GetChatRoutingRule(_ context.Context, _ int64) (*models.ChatRoutingRule, error) {
	return nil, nil
}
func (m *widgetMockStore) ListActiveChatRoutingRules(_ context.Context, _ *int64) ([]*models.ChatRoutingRule, error) {
	return nil, nil
}
func (m *widgetMockStore) UpdateChatRoutingRule(_ context.Context, _ *models.ChatRoutingRule) error {
	return nil
}
func (m *widgetMockStore) DeleteChatRoutingRule(_ context.Context, _ int64) error { return nil }
func (m *widgetMockStore) CountActiveChatsForAgent(_ context.Context, _ models.UserID) (int, error) {
	return 0, nil
}
...
func (m *widgetMockStore) CountTicketsByRequester(_ context.Context, _ string, _ models.UserID) (int, error) {
	return 0, nil
}
